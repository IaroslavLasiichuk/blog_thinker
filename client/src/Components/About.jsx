            ...
            >
              <Testimonial>
                <TestimonialContent>
                  ...
                  <TestimonialText>
                    I'm a young aspiring junior web developer with a passion for
                    technology and a strong desire to make a difference in the
                    world.
                  </TestimonialText>
                </TestimonialContent>
                <TestimonialAvatar
              ...
              <Testimonial>
                <TestimonialContent>
                  ...
                  <TestimonialText>
                    Currently working towards becoming a web developer and has
                    always had a passion for computers and technology.
                  </TestimonialText>
                </TestimonialContent>
                <TestimonialAvatar
                  src={avatarSutton}
              ...
              <Testimonial>
                <TestimonialContent>
                  ...
                  <TestimonialText>
                    Joseph graduated from the University of Denver with a
                    Business Degree and is currently practicing Full Stack Web
                    Development at his Alma Mater.
                  </TestimonialText>
                </TestimonialContent>
                <TestimonialAvatar
                  src={avatarJoseph}
              ...
              <Testimonial>
                <TestimonialContent>
                  <TestimonialHeading>Web Developer</TestimonialHeading>
                  <TestimonialText>
                    I'am currently in construction doing Fire Sprinkler
                    Installing, needed a change so i enrolled to become a Full
                    stack developer
                  </TestimonialText>
                </TestimonialContent>
                <TestimonialAvatar
